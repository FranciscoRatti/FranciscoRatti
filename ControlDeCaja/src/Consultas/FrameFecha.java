...
public class FrameFecha extends JFrame{
    public FrameFecha(ResultSet venta, ResultSet pago) {
        setLayout(null);
    ...
    private class PanelVenta extends JPanel {
        private String[][] datos = new String[100][5];
    ...
    private class PanelPago extends JPanel {
        private String[][] datos = new String[25][5];
